...
<head>
    ...
    <title>Kategori Artikel - Look to the Sky</title>
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-custom">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    ...
                    <form action="<?= base_url('/') ?>" method="GET" class="d-flex" style="max-width: 250px;">
    ...
    <!-- MAIN CONTENT - DAFTAR KATEGORI -->
    <main class="container">
        
        <h2 class="section-title">Daftar Kategori Artikel</h2>
        ...
        <div class="row">
                ...
                <?php foreach ($categories as $cat) : ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="category-card">
                            <a href="<?= base_url('kategori/' . $cat['id']) ?>" class="category-name">
                                <?= esc($cat['name']) ?>
                            </a>
                            <p class="category-desc">
                                <?= esc($cat['description'] ?? 'Jelajahi berbagai artikel menarik dan mendalam seputar topik ' . $cat['name'] . ' di sini.') ?>
                            </p>
                            <a href="<?= base_url('kategori/' . $cat['id']) ?>" class="view-category-btn">
            ...
            <?php else : ?>
                <div class="col-12">
                    <p class="text-muted text-center py-5" style="font-size: 1.2rem;">Belum ada kategori yang tersedia saat ini.</p>
                </div>
            <?php endif; ?>
        </div>
